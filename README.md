...
- [Mac Setup for Web Development \[2025\]](#mac-setup-for-web-development-2025)
...
- 16-inch
- Apple MacBook Pro, M4 Pro 14‑Core CPU, 20‑Core GPU and 16‑Core Neural Engine
- 24 GB RAM
- 512 GB SSD
- QWERTY = English (USA)
...
- Wi-Fi
  - Details
    - Automatically join this network: On
...
- [Figma](https://marketplace.visualstudio.com/items/?itemName=figma.figma-vscode-extension)
...
There are several strategies for SSH keys: one SSH key to rule them all or one SSH key per service. Here I will explain the normal way of connecting [GitHub via SSH](https://docs.github.com/en/authentication/connecting-to-github-with-ssh/generating-a-new-ssh-key-and-adding-it-to-the-ssh-agent).
